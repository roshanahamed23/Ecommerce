      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="md:flex md:items-center md:gap-12">
            <a className="block text-primary-saf dark:text-primary-saf" href="#">
             <Image src={logo} alt='city gold covering' width={70} height={70} />
            </a>
          </div>

          <div className="hidden md:block">
            <form className='flex flex-row border-primary-darbar shadow-sm h-12'>
            <input type='text' placeholder='Search...' className='p-4 rounded-lg active:border-white rounded-r-none text-primary-darbar border w-96 border-r-0 shadow-sm'/>
            <button type='submit' className='p-3 bg-primary-saf text-primary-brown rounded-lg rounded-l-none'>
              search
            </button>
            </form>
          </div>
