    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-brown-light">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-6xl lg:text-7xl font-extrabold text-primary-darbar mb-6 animate-slideUp">
          City Gold
          <span className="block text-primary-saf mt-2">
            Elegance Redefined
          </span>
        </h1>
        <p className="max-w-2xl mx-auto text-xl sm:text-2xl text-primary-darbar mb-10 animate-fadeInOut animation-delay-300">
          Discover exquisite jewelry that captures the essence of urban
          sophistication and timeless beauty.
        </p>
        <button className="bg-primary-saf hover:bg-priamry-darbar text-white text-lg px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 animate-fadeInUp animation-delay-600">
          Explore Collection
        </button>
      </div>
    </div>
